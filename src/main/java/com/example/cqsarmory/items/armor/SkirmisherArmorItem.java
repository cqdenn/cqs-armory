...
public class SkirmisherArmorItem extends ExtendedArmorItem {
    public SkirmisherArmorItem(Type type, Properties properties, AttributeContainer extraAttribute) {
        super(ArmorMaterialsRegistry.SKIRMISHER, type, properties, genericArcherArmorAttributes(0f, 0.2f, 1, 0, 0f, 0.15f, extraAttribute));
    }
    public SkirmisherArmorItem(Type type, Properties properties) {
        super(ArmorMaterialsRegistry.SKIRMISHER, type, properties, genericArcherArmorAttributes(0f, 0.2f, 0, 1, 0f, 0.15f));
    }
