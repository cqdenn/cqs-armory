...
public class WarriorArmorItem extends ExtendedArmorItem {
    public WarriorArmorItem(Type type, Properties properties, AttributeContainer extraAttribute) {
        super(ArmorMaterialsRegistry.WARRIOR, type, properties, genericMeleeArmorAttributes(0.1f, 0.0f, 5, 0.0f, 0, 0, extraAttribute));
    }
    public WarriorArmorItem(Type type, Properties properties) {
        super(ArmorMaterialsRegistry.WARRIOR, type, properties, genericMeleeArmorAttributes(0.1f, 0.0f, 5, 0.0f, 0, 0));
    }
