...
public class SoldierArmorItem extends ExtendedArmorItem {
    public SoldierArmorItem(Type type, Properties properties, AttributeContainer extraAttribute) {
        super(ArmorMaterialsRegistry.SOLDIER, type, properties, genericMeleeArmorAttributes(0.15f, 0.0f, 10, 0, 0.0f, 0, 0, extraAttribute));
    }
    public SoldierArmorItem(Type type, Properties properties) {
        super(ArmorMaterialsRegistry.SOLDIER, type, properties, genericMeleeArmorAttributes(0.15f, 0.0f, 0, 10, 0.0f, 0, 0));
    }
