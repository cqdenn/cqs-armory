...
public class MarksmanArmorItem extends ExtendedArmorItem {
    public MarksmanArmorItem(Type type, Properties properties, AttributeContainer extraAttribute) {
        super(ArmorMaterialsRegistry.MARKSMAN, type, properties, genericArcherArmorAttributes(0.25f, 0f, 1, 0.02f, 0, extraAttribute));
    }
    public MarksmanArmorItem(Type type, Properties properties) {
        super(ArmorMaterialsRegistry.MARKSMAN, type, properties, genericArcherArmorAttributes(0.25f, 0f, 1, 0.02f, 0));
    }
