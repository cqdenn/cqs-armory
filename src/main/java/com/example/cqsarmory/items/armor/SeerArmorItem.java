...
public class SeerArmorItem extends ExtendedArmorItem {
    public SeerArmorItem(Type type, Properties properties, AttributeContainer extraAttribute) {
        super(ArmorMaterialsRegistry.SEER, type, properties, genericMageArmorAttributes(0f, 0.1f, 100, 0.1f, 0f, extraAttribute));
    }
    public SeerArmorItem(Type type, Properties properties) {
        super(ArmorMaterialsRegistry.SEER, type, properties, genericMageArmorAttributes(0f, 0.1f, 100, 0.1f, 0f));
    }
