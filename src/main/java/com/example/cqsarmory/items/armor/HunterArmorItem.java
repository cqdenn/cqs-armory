...
public class HunterArmorItem extends ExtendedArmorItem {
    public HunterArmorItem(Type type, Properties properties, AttributeContainer extraAttribute) {
        super(ArmorMaterialsRegistry.HUNTER, type, properties, genericArcherArmorAttributes(0.1f, 0.0f, 1, 0.01f, 0, extraAttribute));
    }
    public HunterArmorItem(Type type, Properties properties) {
        super(ArmorMaterialsRegistry.HUNTER, type, properties, genericArcherArmorAttributes(0.1f, 0.0f, 1, 0.01f, 0));
    }
