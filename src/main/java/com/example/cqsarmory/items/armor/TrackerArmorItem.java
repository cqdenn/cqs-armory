...
public class TrackerArmorItem extends ExtendedArmorItem {
    public TrackerArmorItem(Type type, Properties properties, AttributeContainer extraAttribute) {
        super(ArmorMaterialsRegistry.TRACKER, type, properties, genericArcherArmorAttributes(0.15f, 0f, 1, 0.015f, 0, extraAttribute));
    }
    public TrackerArmorItem(Type type, Properties properties) {
        super(ArmorMaterialsRegistry.TRACKER, type, properties, genericArcherArmorAttributes(0.15f, 0f, 1, 0.015f, 0));
    }
