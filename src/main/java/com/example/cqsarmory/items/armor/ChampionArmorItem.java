...
public class ChampionArmorItem extends ExtendedArmorItem {
    public ChampionArmorItem(Type type, Properties properties, AttributeContainer extraAttribute) {
        super(ArmorMaterialsRegistry.CHAMPION, type, properties, genericMeleeArmorAttributes(0.2f, 0.15f, 10, 0.0f, extraAttribute));
    }
    public ChampionArmorItem(Type type, Properties properties) {
        super(ArmorMaterialsRegistry.CHAMPION, type, properties, genericMeleeArmorAttributes(0.2f, 0.15f, 10, 0.0f));
    }
