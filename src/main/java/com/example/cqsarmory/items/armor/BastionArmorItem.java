...
public class BastionArmorItem extends ExtendedArmorItem {
    public BastionArmorItem(Type type, Properties properties, AttributeContainer extraAttribute) {
        super(ArmorMaterialsRegistry.BASTION, type, properties, genericMeleeArmorAttributes(0.f, 0f, 0, 0, 0.0f, 5, 25, extraAttribute));
    }
    public BastionArmorItem(Type type, Properties properties) {
        super(ArmorMaterialsRegistry.BASTION, type, properties, genericMeleeArmorAttributes(0f, 0f, 0, 0, 0.0f, 5, 25));
    }
