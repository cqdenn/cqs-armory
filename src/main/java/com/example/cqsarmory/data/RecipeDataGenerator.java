...
public class RecipeDataGenerator extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.SPRING_BOOT.get(), 1)
                .requires(ItemRegistry.MELEE_RUNE.get(), 2)
                .requires(Items.OBSIDIAN, 2)
                .unlockedBy("criteria", InventoryChangeTrigger.TriggerInstance.hasItems(ItemRegistry.MELEE_RUNE.get()))
                .save(recipeOutput);

        ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.EXTRA_AURA.get(), 1)
                .requires(io.redspace.ironsspellbooks.registries.ItemRegistry.ARCANE_INGOT.get(), 3)
                .requires(Ingredient.of(Tags.Items.MATERIALS_POWER_THREE), 3)
                .unlockedBy("criteria", InventoryChangeTrigger.TriggerInstance.hasItems(Items.BLAZE_ROD))
                .save(recipeOutput);

        ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.SUMMON_SHIELD.get(), 1)
                .requires(io.redspace.ironsspellbooks.registries.ItemRegistry.BLOOD_VIAL.get(), 3)
                .requires(Items.SHIELD, 1)
                .requires(Ingredient.of(Tags.Items.MATERIALS_POWER_TWO), 2)
                .unlockedBy("criteria", InventoryChangeTrigger.TriggerInstance.hasItems(Items.BLAZE_ROD))
                .save(recipeOutput);

        ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.ELEMENTAL_BLESSING.get(), 1)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.SUMMONERS_WILL.get(), 1)
                .requires(Items.WITHER_SKELETON_SKULL, 2)
                .requires(Ingredient.of(Tags.Items.MATERIALS_POWER_THREE), 2)
        ...
        /*ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.FULL_DEVOTION.get(), 1)
                .requires(ItemRegistry.WITHERSTEEL_WEAPONSET.ingot().get(), 2)
                .requires(ItemRegistry.ARCHER_RUNE.get(), 2)
                .unlockedBy("criteria", InventoryChangeTrigger.TriggerInstance.hasItems(ItemRegistry.ARCHER_RUNE.get()))
                .save(recipeOutput);*/ //change if ever re-added

        ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.HUNTERS_MARK.get(), 1)
                .requires(ItemRegistry.WITHERSTEEL_WEAPONSET.ingot().get(), 2)
                .requires(ItemRegistry.ARCHER_RUNE.get(), 2)
                .unlockedBy("criteria", InventoryChangeTrigger.TriggerInstance.hasItems(ItemRegistry.ARCHER_RUNE.get()))
                .save(recipeOutput);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.GOOPER.get(), 1)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.SCATTER_QUIVER.get(), 1)
                .requires(ItemRegistry.BASIC_QUIVER.get(), 1)
                .requires(Ingredient.of(Tags.Items.MATERIALS_POWER_THREE), 1)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.ARCANE_SWORDS_BRAND.get(), 1)
                .requires(ItemRegistry.UMBRITE_WEAPONSET.ingot().get(), 1)
                .requires(io.redspace.ironsspellbooks.registries.ItemRegistry.ARCANE_INGOT.get(), 1)
                .requires(ItemRegistry.MELEE_RUNE.get(), 2)
                .unlockedBy("criteria", InventoryChangeTrigger.TriggerInstance.hasItems(io.redspace.ironsspellbooks.registries.ItemRegistry.ARCANE_INGOT.get()))
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.GRAVEYARD_BRAND.get(), 1)
                .requires(Ingredient.of(Tags.Items.MATERIALS_POWER_ONE), 3)
                .requires(io.redspace.ironsspellbooks.registries.ItemRegistry.ARCANE_INGOT.get(), 1)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, ItemRegistry.FLIGHT_BRAND.get(), 1)
                .requires(Ingredient.of(Tags.Items.MATERIALS_POWER_THREE), 2)
