...
public class ExtendedWeaponTier implements Tier {
    ...
    static {
        WITHERSTEEL = new ExtendedWeaponTier("withersteel", 5, 2500, 7.0F, 0.0F, 0.5f, 0.2f, 0f, 4, BlockTags.INCORRECT_FOR_NETHERITE_TOOL, () -> Ingredient.of(new ItemLike[]{ItemRegistry.WITHERSTEEL_WEAPONSET.ingot().get()}));
        ...
        UMBRITE = new ExtendedWeaponTier("umbrite", 3, 2000, 1.0F, 0.5F, 2f, 0.1f, 0.05f, 4, BlockTags.INCORRECT_FOR_NETHERITE_TOOL, () -> Ingredient.of(new ItemLike[]{ItemRegistry.UMBRITE_WEAPONSET.ingot().get()}));
