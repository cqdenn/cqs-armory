...
public class EntityRegistry {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ChainArrow>> CHAIN_ARROW =
            ENTITIES.register("chain_arrow", () -> EntityType.Builder.<ChainArrow>of(ChainArrow::new, MobCategory.MISC)
                    .sized(.5f, .5f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(CqsArmory.MODID, "chain_arrow").toString()));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ScytheProjectile>> SCYTHE_PROJECTILE =
            ENTITIES.register("scythe_projectile", () -> EntityType.Builder.<ScytheProjectile>of(ScytheProjectile::new, MobCategory.MISC)
                    .sized(1f, 0.5f)
                    .clientTrackingRange(64)
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LightningRodEntity>> LIGHTNING_ROD =
            ENTITIES.register("lightning_rod", () -> EntityType.Builder.<LightningRodEntity>of(LightningRodEntity::new, MobCategory.MISC)
                    .sized(1f, 2f)
                    .clientTrackingRange(64)
                    .build(ResourceLocation.fromNamespaceAndPath(CqsArmory.MODID, "lightning_rod").toString()));
