...
public class AttributeRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute> MOMENTUM_JUMPS = ATTRIBUTES.register("momentum_jumps", () -> (new RangedAttribute("attribute.cqs_armory.momentum_jumps", 1.0D, 0.0D, 10000.0D).setSyncable(true)));
