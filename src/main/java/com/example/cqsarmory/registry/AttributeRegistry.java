...
public class AttributeRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute> MOMENTUM_DASHES = ATTRIBUTES.register("momentum_dashes", () -> (new RangedAttribute("attribute.cqs_armory.momentum_dashes", 1.0D, -10000.0D, 10000.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> MOMENTUM_MOVEMENT_COST = ATTRIBUTES.register("momentum_movement_cost", () -> (new RangedAttribute("attribute.cqs_armory.momentum_movement_cost", 0.0D, 0.0D, 10000.0D).setSyncable(true)));
