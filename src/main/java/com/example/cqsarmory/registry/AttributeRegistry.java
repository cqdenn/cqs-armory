...
public class AttributeRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute> LIFE_STEAL = ATTRIBUTES.register("life_steal", () -> (new PercentageAttribute("attribute.cqs_armory.life_steal", 0.0D, 0.0D, 1.0D, 100).setSyncable(true)));
