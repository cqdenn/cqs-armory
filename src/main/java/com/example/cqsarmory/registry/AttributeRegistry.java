...
public class AttributeRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute> MAX_MOMENTUM = ATTRIBUTES.register("max_momentum", () -> (new RangedAttribute("attribute.cqs_armory.max_momentum", 50.0D, 0.0D, 10000.0D).setSyncable(true)));
