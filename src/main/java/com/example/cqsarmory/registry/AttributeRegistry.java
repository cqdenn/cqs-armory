...
public class AttributeRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute> SPEED_STEAL = ATTRIBUTES.register("speed_steal", () -> (new PercentageAttribute("attribute.cqs_armory.speed_steal", 0.0D, 0.0D, 1.0D, 100).setSyncable(true))); // as this introduces and exploit where the player can use stealing enchants
