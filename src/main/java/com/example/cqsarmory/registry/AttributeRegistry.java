...
public class AttributeRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute> MAX_MOMENTUM = ATTRIBUTES.register("max_momentum", () -> (new RangedAttribute("attribute.cqs_armory.max_momentum", 15.0D, 0.0D, 10000.0D).setSyncable(true)));
    ...
    public static final DeferredHolder<Attribute, Attribute> MOMENTUM_ORBS_SPAWNED = ATTRIBUTES.register("momentum_orbs_spawned", () -> (new RangedAttribute("attribute.cqs_armory.momentum_orbs_spawned", 0.0D, 0.0D, 5.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> MOMENTUM_JUMPS = ATTRIBUTES.register("momentum_jumps", () -> (new RangedAttribute("attribute.cqs_armory.momentum_jumps", 0.0D, 0.0D, 10000.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> MOMENTUM_DASHES = ATTRIBUTES.register("momentum_dashes", () -> (new RangedAttribute("attribute.cqs_armory.momentum_dashes", 1.0D, 0.0D, 10000.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> MOMENTUM_MOVEMENT_COST_REDUCTION = ATTRIBUTES.register("momentum_movement_cost_reduction", () -> (new RangedAttribute("attribute.cqs_armory.momentum_movement_cost_reduction", 0.0D, -10000.0D, 10000.0D).setSyncable(true)));
    ...
    public static final DeferredHolder<Attribute, Attribute> AUTO_CRIT = ATTRIBUTES.register("auto_crit", () -> (new RangedAttribute("attribute.cqs_armory.auto_crit", 0.0D, 0.0D, 10000.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> BLEED_CHANCE = ATTRIBUTES.register("bleed_chance", () -> (new PercentageAttribute("attribute.cqs_armory.bleed_chance", 0.0D, 0.0D, 1.0D, 100).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> BACKSTAB_DAMAGE = ATTRIBUTES.register("backstab_damage", () -> (new RangedAttribute("attribute.cqs_armory.backstab_damage", 1.0D, -100.0D, 100.0D).setSyncable(true)));
    public static final DeferredHolder<Attribute, Attribute> LIFE_STEAL = ATTRIBUTES.register("life_steal", () -> (new PercentageAttribute("attribute.cqs_armory.life_steal", 0.0D, 0.0D, 1.0D, 100).setSyncable(true))); //careful adding stealing attributes to bows/any item with offhand and mainhand slot
/*    public static final DeferredHolder<Attribute, Attribute> SPEED_STEAL = ATTRIBUTES.register("speed_steal", () -> (new PercentageAttribute("attribute.cqs_armory.speed_steal", 0.0D, 0.0D, 1.0D, 100).setSyncable(true))); // as this introduces and exploit where the player can use stealing
    public static final DeferredHolder<Attribute, Attribute> MANA_STEAL = ATTRIBUTES.register("mana_steal", () -> (new RangedAttribute("attribute.cqs_armory.mana_steal", 0.0D, 0.0D, 10000.0D).setSyncable(true))); // in both slots to get both effects (or double of the same) while only using one weapon.*/
