...
public class AttributeRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute> EXPLOSIVE_DAMAGE = ATTRIBUTES.register("explosive_damage", () -> (new RangedAttribute("attribute.cqs_armory.explosion_damage", 1.0D, -100.0D, 100.0D).setSyncable(true)));
